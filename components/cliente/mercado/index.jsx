  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 lg:m-20">
      <button
        ...
        className="bg-gray-50 m-5 shadow flex flex-col lg:flex-row  justify-around items-center p-5 transition ease-in-out delay-150 hover:scale-110 sm:rounded-lg"
      >
      ...
      <div className="bg-gray-50 m-5 shadow flex flex-row  justify-around items-center p-5 transition ease-in-out delay-150 hover:scale-110 sm:rounded-lg">
