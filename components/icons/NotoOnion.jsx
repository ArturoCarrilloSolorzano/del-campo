...
export function NotoOnion(props) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 128 128" {...props}>
      ...
      >
        <stop offset=".187" stopColor="#F2A05B"></stop>
        <stop offset=".225" stopColor="#F5AD68"></stop>
        <stop offset=".291" stopColor="#FECC88"></stop>
        <stop offset=".639" stopColor="#FECC88"></stop>
        <stop offset=".658" stopColor="#FECC88"></stop>
        <stop offset=".703" stopColor="#FCC581"></stop>
        <stop offset=".769" stopColor="#F7B16D"></stop>
        <stop offset=".814" stopColor="#F3A05C"></stop>
        <stop offset=".849" stopColor="#E6915B"></stop>
        <stop offset=".905" stopColor="#D77F59"></stop>
        <stop offset=".946" stopColor="#D17858"></stop>
      </radialGradient>
      <path
        fill="url(#svgIDa)"
        d="M62.16 6.84s-7.09-5.02-7.65-2.58s.42 7.32-1.64 10.51c-2.06 3.19-4.88 4.69-7.13 5.44s-26.65 9.95-33.97 34.35s3.94 45.22 21.12 55.19c14.08 8.17 23.37 6.95 23.37 6.95s-1.88 1.69-2.63 1.88c-.75.19-3.28.28-4.5.47c-1.22.19-5.54 1.69-5.16 2.82c.38 1.13 4.13-.47 5.73-.75c1.6-.28 4.32-.47 4.88-.75c.56-.28 3.28-2.16 3.28-2.16s-1.03 2.82-1.97 3.85c-.94 1.03.84 2.44 2.91 1.88s3.57-5.44 3.57-5.44s.09 2.91.09 3.85s-.28 2.44.09 2.82c.38.38 3.19.84 4.04.38s.66-2.35.66-2.35s2.53 1.6 4.13 2.44c1.6.84 3.19 1.69 3.75.94s.09-2.25-.47-2.63s-2.53-1.31-2.91-1.88c-.38-.56-1.13-2.25-1.13-2.25s2.16-1.5 3.1-1.31c.94.19 3.38 2.82 4.69 3.38c1.31.56 3.94 2.35 4.88 2.06c.94-.28 1.6-1.13 1.22-1.6s-3.47-1.97-4.22-2.72c-.75-.75-3.66-3.1-3.66-3.1s14.63-2.44 24.4-11.68c11.22-10.61 22.6-33.75 11.68-56.17c-10.42-21.4-30.69-28.02-37.59-30.41c-3.57-1.24-4.22-3.1-4.65-5.63c-.42-2.53-.7-9.71-2.67-10.14s-5.64 4.34-5.64 4.34z"
      ></path>
      <path
        fill="#D17759"
        d="M58.97 11.48c1.5.14.79-2.53 3.05-2.86c1.92-.28 2.06 2.49 3.28 2.02c1.22-.47.79-4.03.99-5.96c.19-1.88 1.5-2.21 1.5-2.21s-.93-1.03-2.9-.47c-1.97.56-2.72 3.1-2.72 3.1s-1.88-3.28-4.5-3c-2.43.26-3 1.88-3 1.88s1.88.09 2.44 1.5s-.15 5.81 1.86 6z"
      ></path>
      <radialGradient
        id="svgIDb"
        cx="61.131"
